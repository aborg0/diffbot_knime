 ...
 * @author Diffbot Corp.
 */
class DiffbotAnalyzeNodeModel extends NodeModel {
	private DiffbotAnalyzeNodeSettings settings = new DiffbotAnalyzeNodeSettings();

	/**
	 * Constructor for the node model.
	 */
	protected DiffbotAnalyzeNodeModel() {
		...
		ret.append(new SingleCellFactory(newColSpec) {
			...
			public DataCell getCell(final DataRow row) {
				...
				if (cell instanceof StringValue) {
					...
					try {
						return createCell(sv.getStringValue(), settingsAsMap);
	...
	protected DataCell createCell(final String url,
		...
		return JSONCellFactory.create(
				(String) new DiffbotClient(settings.getToken(), String
						.valueOf(settings.getVersion())).callApi("analyze",
	...
	protected void validateSettings(final NodeSettingsRO settings)
			throws InvalidSettingsException {
		final DiffbotAnalyzeNodeSettings dummy = new DiffbotAnalyzeNodeSettings();
